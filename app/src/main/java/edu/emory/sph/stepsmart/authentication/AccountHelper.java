...
public class AccountHelper {
     ...
     * Account type id
     */
    public static final String ACCOUNT_TYPE = "edu.emory.sph.stepsmart";
    ...
    public static final String AUTHTOKEN_TYPE_READ_ONLY_LABEL = "Read only access to a edu.emory.sph.stepsmart account";

    public static final String AUTHTOKEN_TYPE_FULL_ACCESS = "Full access";
    public static final String AUTHTOKEN_TYPE_FULL_ACCESS_LABEL = "Full access to a edu.emory.sph.stepsmart account";
